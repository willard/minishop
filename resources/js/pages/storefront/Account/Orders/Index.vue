...
<template>
    <AccountLayout title="Order History">
        ...
        <div v-if="orders.data.length === 0" class="rounded-xl border p-12 text-center" style="border-color: rgba(28, 26, 23, 0.12)">
            <p class="text-base font-medium" style="color: rgba(28, 26, 23, 0.5)">You haven't placed any orders yet.</p>
        </div>
        ...
        <div v-else class="flex flex-col gap-3">
            ...
            <div v-if="orders.last_page > 1" class="mt-4 flex justify-center gap-1">
                <Link
                    ...
                    :style="{
                        backgroundColor: link.active ? '#1c1a17' : 'transparent',
                        color: link.active ? '#f9f6f0' : 'rgba(28, 26, 23, 0.6)',
