        ...
        <div class="mx-auto max-w-3xl px-6 py-16">
            ...
            <div class="mb-12 text-center">
                ...
                <p class="text-base" style="color: rgba(28, 26, 23, 0.6)">
                    Your order <strong style="color: #1c1a17">{{ order.order_number }}</strong> has been placed
                    and is being processed.
                </p>
                <p class="mt-1 text-sm" style="color: rgba(28, 26, 23, 0.5)">
                    A confirmation will be sent to <strong>{{ order.customer.user.email }}</strong>
                </p>
            </div>
            ...
            >
                ...
                <div class="p-6">
                    ...
                    <div class="divide-y" style="--tw-divide-opacity: 0.08; border-color: rgba(28, 26, 23, 0.08)">
                        <div
                        ...
                        >
                            <div class="min-w-0 flex-1">
                                <p class="text-sm font-medium" style="color: #1c1a17">{{ item.product_name }}</p>
                                <p v-if="item.product_sku" class="mt-0.5 text-xs font-mono" style="color: rgba(28, 26, 23, 0.4)">
                                    {{ item.product_sku }}
                                </p>
                                <p class="mt-1 text-xs" style="color: rgba(28, 26, 23, 0.55)">
                                    {{ formatPrice(item.unit_price) }} × {{ item.quantity }}
                                </p>
                            </div>
                            <span class="text-sm font-semibold flex-shrink-0" style="color: #1c1a17">
                ...
                <!-- Price breakdown -->
                <div class="border-t p-6" style="border-color: rgba(28, 26, 23, 0.1); background-color: #f4f0e8">
                    <div class="space-y-2.5">
                        <div class="flex justify-between text-sm" style="color: rgba(28, 26, 23, 0.65)">
                            <span>Subtotal</span>
            ...
            <div
                ...
                style="border-color: rgba(28, 26, 23, 0.12)"
            >
                <h2 class="mb-4 text-sm font-semibold uppercase tracking-wider" style="color: #1c1a17">
                    Shipping To
                </h2>
                <address class="text-sm not-italic leading-relaxed" style="color: rgba(28, 26, 23, 0.7)">
                    <strong style="color: #1c1a17">{{ order.shipping_name }}</strong><br />
            ...
            <div class="text-center">
                <Link
                    ...
                    class="inline-flex items-center gap-2 rounded-full px-8 py-4 text-sm font-semibold uppercase tracking-widest text-white transition-opacity hover:opacity-80"
