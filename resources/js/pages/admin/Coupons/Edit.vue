...
import { index, update } from '@/actions/App/Http/Controllers/Admin/CouponController';
        ...
        <div class="flex flex-col gap-6 p-4 max-w-2xl">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-muted-foreground font-mono tracking-wide">{{ coupon.code }}</p>
                </div>
            </div>

            <!-- Usage stat -->
            <div class="rounded-lg border border-sidebar-border px-4 py-3 text-sm text-muted-foreground">
                Used <strong class="text-foreground">{{ coupon.used_count }}</strong> time{{ coupon.used_count === 1 ? '' : 's' }}
                <template v-if="coupon.usage_limit !== null">
                    out of <strong class="text-foreground">{{ coupon.usage_limit }}</strong>
                </template>
            </div>
            ...
            >
                ...
                <div class="grid gap-2">
                    ...
                    <Input
                        ...
                        class="uppercase font-mono tracking-wider max-w-xs"
                        required
                    />
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="grid gap-2">
                        ...
                        <Input
                            ...
                            type="number"
                            min="0"
                            :default-value="coupon.minimum_order_amount ?? undefined"
                ...
                <div class="flex items-center gap-2">
                    <Checkbox id="is_active" name="is_active" value="1" :default-value="coupon.is_active" />
