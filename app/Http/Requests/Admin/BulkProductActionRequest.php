...
class BulkProductActionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'action' => ['required', 'string', Rule::in(['delete', 'activate', 'deactivate', 'assign_category', 'assign_tag', 'update_stock', 'update_price'])],
            'category_id' => ['required_if:action,assign_category', 'nullable', 'integer', 'exists:categories,id'],
            'tag_id' => ['required_if:action,assign_tag', 'nullable', 'integer', 'exists:tags,id'],
    ...
    public function messages(): array
    {
        return [
            ...
            'tag_id.required_if' => 'Please select a tag.',
